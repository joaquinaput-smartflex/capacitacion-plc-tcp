...
Sección 2 ████████░░░░░░░░░░░░  40%  🟡 PPT listo, falta guía detallada
...
## Sección 2: Modbus TCP (3.0 hs) 🟡 EN PROGRESO
...
| Guía práctica detallada Modbus | ⬜ Pendiente | Documento Word con paso a paso ampliado |
| Evaluación formal Sección 2 | ⬜ Pendiente | Cuestionario imprimible para los alumnos |
| Cheat sheet Modbus (1 página) | ⬜ Pendiente | Referencia rápida: funciones, mapeo, fórmula |

### Próximos pasos Sección 2:
- [ ] Crear guía práctica Word con código Ladder completo para cada ejercicio
- [ ] Crear cheat sheet imprimible (mapeo de registros + funciones)
